...
ActiveRecord::Schema.define(version: 20170516090148) do
  ...
  create_table "contacts", id: false, force: :cascade do |t|
    ...
    t.index ["contact_id", "user_id"], name: "index_contacts_on_contact_id_and_user_id", unique: true, using: :btree
    t.index ["user_id", "contact_id"], name: "index_contacts_on_user_id_and_contact_id", unique: true, using: :btree
  end
